package tk.chuanjing.demo.crawler.jd;
...
import tk.chuanjing.demo.crawler.jd.util.HttpUtils;
 ...
 *
 * 简化版的JD爬虫，对整个工程的简化，不存入数据库
 */
public class CrawlerSimpleJD {
    ...
    public static void main(String[] args) {
        CrawlerSimpleJD crawlerSimpleJD = new CrawlerSimpleJD();
        try {
            crawlerSimpleJD.crawlerJD();
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
